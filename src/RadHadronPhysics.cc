...
RadHadronPhysics::RadHadronPhysics(const G4String& name)
                          :G4VPhysicsConstructor(name)
{;}

RadHadronPhysics::~RadHadronPhysics()
{;}


void RadHadronPhysics::ConstructParticle()
{
...
void RadHadronPhysics::ConstructProcess()
{
